...
def downgrade() -> None:
    # if_exists: tolerate stamped-but-partial or manually altered databases.
    op.drop_index(op.f("ix_design_revisions_design_id"), table_name="design_revisions", if_exists=True)
    op.drop_table("design_revisions", if_exists=True)
    op.drop_index(op.f("ix_ai_jobs_user_id"), table_name="ai_jobs", if_exists=True)
    op.drop_index(op.f("ix_ai_jobs_design_id"), table_name="ai_jobs", if_exists=True)
    op.drop_table("ai_jobs", if_exists=True)
    op.drop_index(op.f("ix_design_exports_user_id"), table_name="design_exports", if_exists=True)
    op.drop_index(op.f("ix_design_exports_design_id"), table_name="design_exports", if_exists=True)
    op.drop_table("design_exports", if_exists=True)
    op.drop_index(op.f("ix_ratings_user_id"), table_name="ratings", if_exists=True)
    op.drop_index(op.f("ix_ratings_gallery_item_id"), table_name="ratings", if_exists=True)
    op.drop_table("ratings", if_exists=True)
    op.drop_index(op.f("ix_gallery_items_user_id"), table_name="gallery_items", if_exists=True)
    op.drop_index(op.f("ix_gallery_items_design_id"), table_name="gallery_items", if_exists=True)
    op.drop_table("gallery_items", if_exists=True)
    op.drop_index(op.f("ix_garment_designs_user_id"), table_name="garment_designs", if_exists=True)
    op.drop_index(op.f("ix_garment_designs_garment_category"), table_name="garment_designs", if_exists=True)
    op.drop_table("garment_designs", if_exists=True)
    op.drop_table("color_palettes", if_exists=True)
    op.drop_index(op.f("ix_material_definitions_family"), table_name="material_definitions", if_exists=True)
    op.drop_table("material_definitions", if_exists=True)
    op.drop_index(op.f("ix_garment_templates_category"), table_name="garment_templates", if_exists=True)
    op.drop_table("garment_templates", if_exists=True)
