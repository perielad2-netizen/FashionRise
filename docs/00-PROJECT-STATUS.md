...
**Last updated:** 2026-09-14 (Magic look in-app: resilient poll + job-id early store + See last result + Your look RawImage; kid UI redesign still pending — see `docs/01-KID-UX-VISION.md`)
